...
/* The following macros override the default bit positions for the lum and alpha
...
/* PXP is used only for copy operations in LumA44 fromat and the LCD
   controller expects premultiplied pixels within framebuffer.
   => premultiplied colors have to be used */
...
/* fill operations cannot be done by PXP, because fill color is requested in RGB format */
